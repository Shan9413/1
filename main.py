...
async def account_login(bot: Client, m: Message):
    ...
    if user is not None and user not in sudo_users:
        await m.reply("**TUM BHOSADI WALE NIKAL LO**", quote=True)
        return
    else:
        editable = await m.reply_text(
        ...
        for i in range(arg, len(links)):
            ...
            if "classplusapp" in url:
                headers = {
                    'Host': 'api.classplusapp.com',
                    'x-access-token':
                    'eyJhbGciOiJIUzM4NCIsInR5cCI6IkpXVCJ9..q_iVpHJ1jgpHvb_v3b35AiyjrnW34PuWs00T5tWdyJn9Cm5tzI3ndKhY8I_sPmyn',
                    'user-agent': 'Mobile-Android',
                    'app-version': '1.4.37.1',
                    'api-version': '18',
                    'device-id': '5d0d17ac8b3c9f51',
...
#                 url1 = b
            ...
            if "pdf" in url:
                ...
                await prog.delete(True)
                await m.reply_document(f"{name}.pdf", caption=cc1)
